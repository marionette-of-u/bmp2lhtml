...
#    define TTXY_LEGACY_WSTRINGIZE_X(a) TTXY_LEGACY_WSTRINGIZE_X_A((a))
#    define TTXY_LEGACY_WSTRINGIZE_X_A(arg) TTXY_LEGACY_WSTRINGIZE_X_I arg
# elif BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_MWCC()
#    define TTXY_LEGACY_WSTRINGIZE_X(text) TTXY_LEGACY_WSTRINGIZE_X_OO((text))
#    define TTXY_LEGACY_WSTRINGIZE_X_OO(par) TTXY_LEGACY_WSTRINGIZE_X_I ## par
# else
#    define TTXY_LEGACY_WSTRINGIZE_X(text) TTXY_LEGACY_WSTRINGIZE_X_I(text)
# endif

# define TTXY_LEGACY_WSTRINGIZE_X_I(a) L ## a

# define TTXY_LEGACY_WSTRINGIZE(a) TTXY_LEGACY_WSTRINGIZE_X(BOOST_PP_STRINGIZE(a))
...
#define TTXY_LEGACY_SEQUENTIALEXPR_EAT(a)
#define TTXY_LEGACY_SEQUENTIALEXPR_VOMIT(a) a

#define TTXY_LEGACY_SEQUENTIALEXPR_I(r, op, i, e) \
    BOOST_PP_IF(i, TTXY_LEGACY_SEQUENTIALEXPR_VOMIT, TTXY_LEGACY_SEQUENTIALEXPR_EAT)(op) (e)

#define TTXY_LEGACY_SEQUENTIALEXPR(op, seq) \
    BOOST_PP_SEQ_FOR_EACH_I(TTXY_LEGACY_SEQUENTIALEXPR_I, op, seq)

#define TTXY_LEGACY_SEQEXPR TTXY_LEGACY_SEQUENTIALEXPR
